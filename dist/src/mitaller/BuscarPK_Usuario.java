...
public class BuscarPK_Usuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(BTN_Regresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 400, -1, -1));

        rfc_txt.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        rfc_txt.setForeground(new java.awt.Color(255, 255, 255));
        rfc_txt.setText("ID");
        jPanel2.add(rfc_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 20, -1, -1));
        ...
        username_txt.setText("Cargo");
        jPanel2.add(username_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 260, -1, -1));
        ...
        jPanel2.add(tituloabajo, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 420, -1, -1));
        ...
        jPanel2.add(BTN, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 340, -1, -1));
        ...
        jPanel2.add(username_txt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 200, -1, -1));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 160, 710, 450));
    ...
    private void BTN_AgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BTN_AgregarMouseClicked
        try {
            ...
            if (rs.next()) {
                ...
                this.setVisible(false);
                new BuscarPK_Usuario().setVisible(true);
            }
        } catch (Exception e) {
            System.err.print(e);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarPK_Usuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
public class AñadirClientePresupuesto extends javax.swing.JFrame {
    ...
    public AñadirClientePresupuesto() {
    ...
    private void initComponents() {
        ...
        jPanel2.add(nombre_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 130, -1, -1));
    ...
    private void BTN_AgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BTN_AgregarMouseClicked
        try {
            ...
            if (Nombre.equals("") || Direccion.equals("") || Correo.equals("")
                ...
                int resultadooo = JOptionPane.showConfirmDialog(this, "¿Falta registrar Vehiculo?", "Mi Taller", c);
                if (resultadooo == 0) {
                    this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AñadirClientePresupuesto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
public class BuscarPK_VehiculoEmpleado extends javax.swing.JFrame {
    ...
    public BuscarPK_VehiculoEmpleado() {
    ...
    private void initComponents() {
        ...
        jPanel2.add(BTN, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 460, -1, -1));
        ...
        Titulo_central.setText("Busqueda por Placas");
    ...
    private void BTN_AgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BTN_AgregarMouseClicked
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("select * from automovil where placas = ?  ORDER BY placas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarPK_VehiculoEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
public class MostrarEnCursoEmpleado extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();
    DefaultTableModel table = new DefaultTableModel();

    public MostrarEnCursoEmpleado() {
    ...
    void consultar() {
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("select entrada.id,automovil.placas,automovil.modelo,automovil.color,estatus.estado"
                    + " from automovil,estatus,entrada"
                    + " where automovil.placas = entrada.placas && entrada.id = estatus.placas && estatus.estado = 'Revision' ORDER BY entrada.id DESC");

            ResultSet rs = pst.executeQuery();
            Object[] ref = new Object[5];
            table = (DefaultTableModel) Tabla.getModel();
            while (rs.next()) {
                ref[0] = rs.getString("entrada.id");
                ref[1] = rs.getString("automovil.placas");
                ref[2] = rs.getString("automovil.modelo");
                ref[3] = rs.getString("automovil.color");
                ref[4] = rs.getString("estatus.estado");
                table.addRow(ref);
            }
    ...
    private void initComponents() {
        ...
        Titulo_central.setText("En Curso");
        jPanel1.add(Titulo_central, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 80, -1, -1));
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID de entrada", "Placas", "Modelo", "Color", "Estado"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarEnCursoEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

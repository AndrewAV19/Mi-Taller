...
public class EliminarMecanico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(correo_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 260, -1, -1));
        ...
        jPanel2.add(BTN, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 400, -1, -1));
        ...
        Titulo_central.setText("Eliminar Mecanico");
    ...
    private void BTNMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BTNMouseClicked
        try {
            ...
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("delete from mecanico where id_mecanico = ?");
            ...
            BTN_Agregar.setVisible(true);
            BTN.setVisible(false);
            JOptionPane.showMessageDialog(null, "Mecanico eliminado", "Mi Taller", JOptionPane.INFORMATION_MESSAGE);
            this.setVisible(false);
            new EliminarMecanico().setVisible(true);
        } catch (Exception e) {
            System.err.print(e);

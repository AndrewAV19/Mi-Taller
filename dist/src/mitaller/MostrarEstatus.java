...
public class MostrarEstatus extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();
    DefaultTableModel table = new DefaultTableModel();

    public MostrarEstatus() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarEstatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

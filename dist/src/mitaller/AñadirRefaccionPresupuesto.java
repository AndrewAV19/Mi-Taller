...
public class AñadirRefaccionPresupuesto extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();

    public AñadirRefaccionPresupuesto() {
    ...
    private void BTN_AgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BTN_AgregarMouseClicked
        try {
            ...
            if (ID.equals("") || Nombre.equals("") || Precio.equals("")) {
                ...
                if (resultadooo == 0) {
                    this.setVisible(false);
                    new AñadirRefaccionPresupuesto().setVisible(true);
                } else {
                    this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AñadirRefaccionPresupuesto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

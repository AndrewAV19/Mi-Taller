...
public class InventarioEgresos2028 extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();

    public InventarioEgresos2028() {
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2028-01-01' AND '2028-01-31'");
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2028-02-01' AND '2028-02-28'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2028-03-01' AND '2028-03-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2028-04-01' AND '2028-04-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2028-05-01' AND '2028-05-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2028-06-01' AND '2028-06-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2028-07-01' AND '2028-07-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2028-08-01' AND '2028-08-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2028-09-01' AND '2028-09-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2028-10-01' AND '2028-10-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2028-11-01' AND '2028-11-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2028-12-01' AND '2028-12-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
    ...
    private void initComponents() {
        ...
        jButton2027 = new javax.swing.JButton();
        ...
        jButton2027.setBackground(new java.awt.Color(0, 102, 153));
        jButton2027.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jButton2027.setText("2027");
        jButton2027.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButton2027MouseClicked(evt);
            }
        });
        jButton2027.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jButton2027KeyTyped(evt);
            }
        });
        ...
        tiutulo_central.setText("Egresos 2028");
    ...
    private void jButton2024MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2024MouseClicked
        this.setVisible(false);
        new InventarioEgresos2024().setVisible(true);
        // TODO add your handling code here:
    ...
    private void jButton2025MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2025MouseClicked
        this.setVisible(false);
        new InventarioEgresos2025().setVisible(true);
        // TODO add your handling code here:
    ...
    private void jButton2026MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2026MouseClicked
        this.setVisible(false);
        new InventarioEgresos2026().setVisible(true);
        // TODO add your handling code here:
    }//GEN-LAST:event_jButton2026MouseClicked

    private void jButton2027MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2027MouseClicked
        this.setVisible(false);
        new InventarioEgresos2027().setVisible(true);
        // TODO add your handling code here:
    }//GEN-LAST:event_jButton2027MouseClicked

    private void jButton2027KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButton2027KeyTyped

        // TODO add your handling code here:
    }//GEN-LAST:event_jButton2027KeyTyped

    private void jButton2029MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2029MouseClicked
        this.setVisible(false);
        new InventarioEgresos2029().setVisible(true);
        // TODO add your handling code here:
    ...
    private void jButton2030MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2030MouseClicked
        this.setVisible(false);
        new InventarioEgresos2030().setVisible(true);
        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventarioEgresos2028.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InventarioEgresos2028().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton jButton2027;

...
public class AñadirPresupuesto extends javax.swing.JFrame {
    ...
    public void ConsultarCliente(JComboBox Clientes) {
        try {
            ...
            PreparedStatement pst1 = cn1.prepareStatement("SELECT presupuesto1.id_presupuesto,clientes.nombre FROM presupuesto1, clientes WHERE presupuesto1.id_cliente = clientes.rfc ORDER BY clientes.nombre");
    ...
    public void ConsultarRefaccion(JComboBox Refaccion) {
        try {
            ...
            String texto1;
            Connection cn1 = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst1 = cn1.prepareStatement("select id_refaccion,nombre from hoja_refacciones ORDER BY nombre");
    ...
    private void initComponents() {
        ...
        rfc_txt1 = new javax.swing.JLabel();
        ...
        Titulo_central.setText("Añadir que se Necesito");
        jPanel1.add(Titulo_central, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 90, -1, -1));
        ...
        rfc_txt.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        rfc_txt.setForeground(new java.awt.Color(255, 255, 255));
        rfc_txt.setText("*Cambiar al ID que corresponde");
        jPanel2.add(rfc_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 110, -1, -1));
        ...
        rfc_txt1.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        rfc_txt1.setForeground(new java.awt.Color(255, 255, 255));
        rfc_txt1.setText("ID Presupuesto");
        jPanel2.add(rfc_txt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 70, -1, -1));
        ...
        try {
            ...
            if (CANTIDAD.equals("")) {
                ...
                if (resultadooo == 0) {
                    ...
                    new AñadirPresupuesto().setVisible(true);
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AñadirPresupuesto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel rfc_txt1;

...
public class MostrarEnCurso extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();
    DefaultTableModel table = new DefaultTableModel();

    public MostrarEnCurso() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarEnCurso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

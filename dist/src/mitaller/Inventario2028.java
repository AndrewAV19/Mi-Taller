...
public class Inventario2028 extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();

    public Inventario2028() {
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2028-01-01' AND '2028-01-31'");
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2028-02-01' AND '2028-02-28'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2028-03-01' AND '2028-03-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2028-04-01' AND '2028-04-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2028-05-01' AND '2028-05-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2028-06-01' AND '2028-06-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2028-07-01' AND '2028-07-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2028-08-01' AND '2028-08-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2028-09-01' AND '2028-09-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2028-10-01' AND '2028-10-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2028-11-01' AND '2028-11-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2028-12-01' AND '2028-12-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
    ...
    private void initComponents() {
        ...
        tiutulo_central.setText("Inventario 2028");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inventario2028.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

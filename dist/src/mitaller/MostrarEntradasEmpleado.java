...
public class MostrarEntradasEmpleado extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();
    DefaultTableModel table = new DefaultTableModel();

    public MostrarEntradasEmpleado() {
    ...
    void consultar() {
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("select entrada.id, entrada.placas, entrada.fecha_entrada, entrada.hora_entrada, entrada.reporte, mecanico.nombre from entrada, mecanico where entrada.id_mecanico = mecanico.id_mecanico ORDER BY entrada.id DESC");

            ResultSet rs = pst.executeQuery();
            Object[] clientes = new Object[6];
            table = (DefaultTableModel) Tabla.getModel();
            while (rs.next()) {
                clientes[0] = rs.getString("entrada.id");
                clientes[1] = rs.getString("entrada.placas");
                //clientes [2] = rs.getString("apellido");
                clientes[2] = rs.getString("entrada.fecha_entrada");
                clientes[3] = rs.getString("entrada.hora_entrada");
                clientes[4] = rs.getString("entrada.reporte");
                clientes[5] = rs.getString("mecanico.nombre");
    ...
    private void initComponents() {
        ...
        Titulo_central.setText("Tabla de Entradas");
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID de entrada", "Placas", "Fecha entrada", "Hora entrada", "Reporte", "Mecanico"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarEntradasEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

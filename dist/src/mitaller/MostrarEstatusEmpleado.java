...
public class MostrarEstatusEmpleado extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();
    DefaultTableModel table = new DefaultTableModel();

    public MostrarEstatusEmpleado() {
    ...
    void consultar() {
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("select entrada.fecha_entrada,automovil.placas,automovil.vehiculo,automovil.modelo,automovil.color, estatus.estado,presupuesto1.total from automovil,estatus,entrada,presupuesto1 where automovil.placas = entrada.placas && entrada.id = estatus.placas && entrada.id = presupuesto1.placas && estatus.estado = 'Concluido' ORDER BY entrada.fecha_entrada DESC");
            ...
            while (rs.next()) {
                ref[0] = rs.getString("entrada.fecha_entrada");
                ref[1] = rs.getString("automovil.placas");
                ref[2] = rs.getString("automovil.vehiculo");
                ref[3] = rs.getString("automovil.modelo");
                ref[4] = rs.getString("automovil.color");
                ref[5] = rs.getString("estatus.estado");
                // Formatear el campo "presupuesto1.total" en pesos
                double total = rs.getDouble("presupuesto1.total");
                ref[6] = decimalFormat.format(total);
    ...
    private void initComponents() {
        ...
        Titulo_central.setText("Historial");
        jPanel1.add(Titulo_central, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 80, -1, -1));
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fecha de Entrada", "Placas", "Vehiculo", "Modelo", "Color", "Estado", "Total"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarEstatusEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
public class AñadirClienteAutomovilEmpleado extends javax.swing.JFrame {
    ...
    public AñadirClienteAutomovilEmpleado() {
    ...
    private void initComponents() {
        ...
        Titulo_central.setText("Añadir Cliente");
        ...
        jPanel2.add(nombre_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 80, -1, -1));
        ...
        jPanel2.add(nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 130, 210, 30));
        ...
        jPanel2.add(direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 210, 210, 30));
        ...
        jPanel2.add(correo_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 250, -1, -1));
...
// TODO add your handling code here:
        ...
        try {
            ...
            if (Nombre.equals("") || Direccion.equals("") || Correo.equals("")
                ...
                JOptionPane.showMessageDialog(this, "Uno o mas campos estan vacios, favor de llenarlos."
                        + "", "Mi Taller", JOptionPane.INFORMATION_MESSAGE);
            } else {
                pst.setString(1, "0");
                ...
                pst.setString(6, Telefono2);
                pst.executeUpdate();
                LimpiarTextos();
                JOptionPane.showMessageDialog(null, "Cliente Guardado", "Mi Taller", JOptionPane.INFORMATION_MESSAGE);
                this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AñadirClienteAutomovilEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

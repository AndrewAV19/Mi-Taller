 ...
 * @author Andrew
 */
public class MostrarClientesEmpleados extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();
    DefaultTableModel table = new DefaultTableModel();

    public MostrarClientesEmpleados() {
    ...
    private void initComponents() {
        ...
        Titulo_central.setText("Tabla de Clientes");
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Direccion", "Email", "Celular", "Telefono fijo"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarClientesEmpleados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

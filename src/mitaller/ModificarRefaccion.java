...
public class ModificarRefaccion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        id_txt.setText("ID");
        jPanel2.add(id_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 20, -1, -1));
        ...
        jPanel2.add(BTN, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 210, -1, -1));
        ...
        Titulo_central.setText("Modificar Refaccion o Mano obra");
        jPanel1.add(Titulo_central, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, -1, -1));
    ...
    private void BTN_AgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BTN_AgregarMouseClicked
        try {
            ...
            if (rs.next()) {
                //IDD.setText(rs.getString("id_refaccion"));
                nombre.setText(rs.getString("nombre"));
                precio.setText(rs.getString("precio"));
            } else {
                JOptionPane.showMessageDialog(null, "Refaccion no encontrada");
                this.setVisible(false);
                new ModificarRefaccion().setVisible(true);
            }
        } catch (Exception e) {
            System.err.print(e);
        }
    ...
    private void BTNMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BTNMouseClicked
        try {
            ...
            //String ID = IDD.getText().trim();
            String Nombre = nombre.getText().trim();
            String PRECIO = precio.getText().trim();

            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("update hoja_refacciones set id_refaccion = '" + ID + "',nombre = '" + Nombre + "',precio = '" + PRECIO + "' where id_refaccion = '" + ID + "'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarRefaccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

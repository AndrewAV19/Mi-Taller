...
public class MostrarMecanicos extends javax.swing.JFrame {
    ...
    void consultar() {
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("select * from mecanico ORDER BY nombre");

            ResultSet rs = pst.executeQuery();
            Object[] mecanico = new Object[5];
            table = (DefaultTableModel) Tabla.getModel();
            while (rs.next()) {
                mecanico[0] = rs.getString("id_mecanico");
                mecanico[1] = rs.getString("nombre");
                //mecanico [2] = rs.getString("apellido");
                mecanico[2] = rs.getString("direccion");
                mecanico[3] = rs.getString("correo");
                mecanico[4] = rs.getString("telefono");
                //mecanico [5] = rs.getString("telefono2");

                table.addRow(mecanico);
            }
    ...
    private void initComponents() {
        ...
        Titulo_central.setText("Tabla de Mecanicos");
        ...
        jPanel2.add(tituloabajo, new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 480, -1, -1));
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Direccion", "Email", "Celular"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarMecanicos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

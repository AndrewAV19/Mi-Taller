...
public class MostrarConcluidos extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();
    DefaultTableModel table = new DefaultTableModel();

    public MostrarConcluidos() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarConcluidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

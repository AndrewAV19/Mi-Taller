...
public class InventarioEgresos2029 extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();

    public InventarioEgresos2029() {
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2029-01-01' AND '2029-01-31'");
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2029-02-01' AND '2029-02-28'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2029-03-01' AND '2029-03-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2029-04-01' AND '2029-04-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2029-05-01' AND '2029-05-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2029-06-01' AND '2029-06-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2029-07-01' AND '2029-07-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2029-08-01' AND '2029-08-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2029-09-01' AND '2029-09-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2029-10-01' AND '2029-10-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2029-11-01' AND '2029-11-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(monto) FROM egresos WHERE fecha BETWEEN '2029-12-01' AND '2029-12-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
    ...
    private void initComponents() {
        ...
        tiutulo_central.setText("Egresos 2029");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventarioEgresos2029.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

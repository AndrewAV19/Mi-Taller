...
public class Inventario2026 extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();

    public Inventario2026() {
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2026-01-01' AND '2026-01-31'");
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2026-02-01' AND '2026-02-28'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2026-03-01' AND '2026-03-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2026-04-01' AND '2026-04-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2026-05-01' AND '2026-05-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2026-06-01' AND '2026-06-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2026-07-01' AND '2026-07-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2026-08-01' AND '2026-08-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2026-09-01' AND '2026-09-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2026-10-01' AND '2026-10-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2026-11-01' AND '2026-11-30'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("SELECT SUM(presupuesto1.total) FROM presupuesto1 WHERE presupuesto1.fecha BETWEEN '2026-12-01' AND '2026-12-31'");
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                double resultado = rs.getDouble(1);
                NumberFormat formatoMoneda = NumberFormat.getCurrencyInstance(new Locale("es", "MX"));
    ...
    private void initComponents() {
        ...
        tiutulo_central.setText("Inventario 2026");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inventario2026.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

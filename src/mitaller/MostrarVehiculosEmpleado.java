...
public class MostrarVehiculosEmpleado extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();
    DefaultTableModel table = new DefaultTableModel();

    public MostrarVehiculosEmpleado() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarVehiculosEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

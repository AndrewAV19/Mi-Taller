...
public class MostrarConcluidosEmpleado extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();
    DefaultTableModel table = new DefaultTableModel();

    public MostrarConcluidosEmpleado() {
    ...
    void consultar() {
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("select entrada.id,automovil.placas,automovil.modelo,automovil.color,estatus.estado"
                    ...
                    + " where automovil.placas = entrada.placas && entrada.id = estatus.placas && estatus.estado = 'Concluido' ORDER BY entrada.id DESC");
    ...
    private void initComponents() {
        ...
        Titulo_central.setText("Concluidos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarConcluidosEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

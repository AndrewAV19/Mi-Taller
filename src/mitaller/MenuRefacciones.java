...
public class MenuRefacciones extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();

    public MenuRefacciones() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuRefacciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

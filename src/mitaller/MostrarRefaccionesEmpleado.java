...
public class MostrarRefaccionesEmpleado extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();
    DefaultTableModel table = new DefaultTableModel();

    public MostrarRefaccionesEmpleado() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarRefaccionesEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

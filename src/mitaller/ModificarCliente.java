...
public class ModificarCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Titulo_central.setText("Modificar Cliente");
    ...
    private void BTNMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BTNMouseClicked
        try {
            ...
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tecnoauto", "root", "");
            PreparedStatement pst = cn.prepareStatement("update clientes set rfc = '" + RFC + "',nombre = '" + Nombre + "',direccion = '" + Direccion + "',correo = '" + Correo + "',telefono = '" + Telefono + "',telefono2 = '" + Telefono2 + "' where rfc = '" + RFC + "'");

 ...
 * @author Andrew
 */
public class MostrarEgresos extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();
    DefaultTableModel table = new DefaultTableModel();

    public MostrarEgresos() {
    ...
    void consultar() {
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("select * from egresos ORDER BY fecha DESC");
            ...
            while (rs.next()) {
                ...
                clientes[1] = rs.getString("titulo");
                //clientes [2] = rs.getString("apellido");
                clientes[2] = rs.getString("fecha");
                clientes[3] = rs.getString("descripcion");
                clientes[4] = rs.getString("provedor");
                double monto = rs.getDouble("monto");
                clientes[5] = decimalFormat.format(monto);
    ...
    private void initComponents() {
        ...
        Titulo_central.setText("Tabla de Egresos");
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Titulo", "Fecha", "Descripcion", "Proveedor", "Monto"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarEgresos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
public class MostrarRefacciones extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();
    DefaultTableModel table = new DefaultTableModel();

    public MostrarRefacciones() {
    ...
    void consultar() {
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("select * from hoja_refacciones ORDER BY id_refaccion");
            ...
            while (rs.next()) {
                ref[0] = rs.getString("id_refaccion");
                ref[1] = rs.getString("nombre");
                double precio = rs.getDouble("precio");
                ref[2] = decimalFormat.format(precio);
    ...
    private void initComponents() {
        ...
        Titulo_central.setText("Tabla de Refacciones & Mano obra");
        jPanel1.add(Titulo_central, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 70, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarRefacciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarRefacciones().setVisible(true);
            }
        });
    }
